...
def test_dismiss_popup_success():
    page = FakePage(visible_selector="button[aria-label='Close']:visible, button[aria-label='close']:visible, .close-button:visible, .modal-close:visible, [data-testid='close-button']:visible, button:has-text('Dismiss'):visible, button:has-text('Close'):visible")
    ...
    locator = page.locators["button[aria-label='Close']:visible, button[aria-label='close']:visible, .close-button:visible, .modal-close:visible, [data-testid='close-button']:visible, button:has-text('Dismiss'):visible, button:has-text('Close'):visible"]
...
def test_dismiss_popup_exception():
    page = FakePage(throw_on_selector="button[aria-label='Close']:visible, button[aria-label='close']:visible, .close-button:visible, .modal-close:visible, [data-testid='close-button']:visible, button:has-text('Dismiss'):visible, button:has-text('Close'):visible")
    browser = FakeBrowser(page)
