...
class FakePage:
    ...
    def locator(self, selector: str) -> FakeLocator:
        if selector not in self.locators:
            is_visible = self.visible_selector in selector if self.visible_selector else False
            throw_on_visible = self.throw_on_selector in selector if self.throw_on_selector else False
