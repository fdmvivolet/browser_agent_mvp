...
def test_dismiss_popup_success():
    target_selector = "button[aria-label='Close']:visible, button[aria-label='close']:visible, .close-button:visible, .modal-close:visible, [data-testid='close-button']:visible, button:has-text('Dismiss'):visible, button:has-text('Close'):visible"
